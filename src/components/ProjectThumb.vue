<template lang="pug">
    div(class="w-full lg:w-4/5 mb-8 lg:mb-32")
        div(class="Ratio Ratio--16x9 bg-white mb-4" data-aos="fade-right")
        ...
        div(class="lg:w-3/5")
          div(class="flex items-center text-blue-darker")
            span(class="inline-block pr-3 text-base" data-aos="fade-right") {{loc}}
            span(class="flex-1 header-line bg-blue-darker")
          h1(class="text-xl lg:text-4xl text-blue-darker" data-aos="fade-right") {{title}}
</template>
